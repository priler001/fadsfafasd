 ...
 * Counter prototype
 */
function aCounter(t){function i(t){return this.node=t.node,this.from=t.from||0,this.to=t.to,this.duration=t.duration||3e3,this.refresh=t.refresh||30,this.formatter=t.formatter,this.onUpdate=t.onUpdate,this.onComplete=t.onComplete,this.node.counter=this,this}return i.prototype.run=function(){clearInterval(this.interval),this.value=this.from,this.loops=Math.ceil(this.duration/this.refresh),this.increment=(this.to-this.from)/this.loops,this.loop=0,this.interval=setInterval(this.update.bind(this),this.refresh)},i.prototype.update=function(){this.value+=this.increment,this.loop++,this.onUpdate instanceof Function&&this.onUpdate(this),this.loop>=this.loops&&(clearInterval(this.interval),this.value=this.to,this.onComplete instanceof Function&&this.onComplete(this)),this.render()},i.prototype.render=function(){this.formatter instanceof Function?this.node.innerHTML=this.formatter.call(this,~~this.value):this.node.innerHTML=~~this.value},new i(t)}

/**
 * Progress bar prototype
 */
function aProgress(t){function e(t){return this.node=t.node,this.counter=t.counter||this.node.querySelector(".progress-linear-counter"),this.bar=t.bar||this.node.querySelector(".progress-linear-bar"),this.node.progress=this,this.counter.progress=this,this.bar.progress=this,this}return e.prototype.load=function(){this.value=parseInt(this.counter.textContent,10),this.counter.counter instanceof Object?this.counter.counter.to=this.value:aCounter({node:this.counter,to:this.value,duration:1e3,onComplete:function(t){this.bindWatch()}.bind(this)})},e.prototype.reset=function(){this.unbindWatch(),this.node.classList.remove("animated-first"),this.counter.innerHTML="0",this.bar.style.width=0},e.prototype.launch=function(){this.node.classList.contains("animated-first")||(this.bar.style.width=this.value+"%",this.counter.counter.run(),this.node.classList.add("animated-first"),this.unbindScroll())},e.prototype.relaunch=function(){this.reset(),setTimeout(this.launch.bind(this),100)},e.prototype.intoView=function(t,e){var n=t.getBoundingClientRect(),i=n.top<window.innerHeight&&n.bottom>0;return e instanceof Function&&i&&e(),i},e.prototype.scrollHandler=function(){this.intoView(this.node,this.launch.bind(this))},e.prototype.bindScroll=function(){this.scrollHandler(),this.scrollHandler=this.scrollHandler.bind(this),window.addEventListener("scroll",this.scrollHandler)},e.prototype.unbindScroll=function(){window.removeEventListener("scroll",this.scrollHandler)},e.prototype.watchHandler=function(){this.progress.load(),this.progress.reset(),setTimeout(this.progress.launch.bind(this.progress),1e3)},e.prototype.bindWatch=function(){this.counter.addEventListener("blur",this.watchHandler)},e.prototype.unbindWatch=function(){this.counter.removeEventListener("blur",this.watchHandler)},new e(t)}
